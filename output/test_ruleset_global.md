...
| brand.epicgames.com | AWSALB | AWS ELB application load balancer |
| brand.epicgames.com | AWSALBCORS | This cookie is managed by AWS and is used for load balancing. |
| brand.epicgames.com | PHPSESSID | PHP session cookie associated with embedded content from this domain.<br/> |
| communityportal.epicgames.com | CookieConsentPolicy | Used to apply end-user cookie consent preferences set by our client-side utility. |
| communityportal.epicgames.com | LSKey-c$CookieConsentPolicy | Used to apply end-user cookie consent preferences set by our client-side utility. |
| dev.epicgames.com | EPIC_CLIENT_SESSION | Authentication cookie |
| dev.epicgames.com | EPIC_SESSION_DEVPORTAL | User Session |
...
| eoshelp.epicgames.com | sfdc-stream | Common Salesforce Cookie |
